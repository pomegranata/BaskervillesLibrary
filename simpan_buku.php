...
?>
		...
		document.location='isi-buku.php';
		</script>
	<?php
	}
	...
	?>
		<script language="JavaScript">
		alert ('Isian tahun buku masih kosong. Silahkan diisi dahulu');
		document.location='isi-buku.php';
		</script>
	<?php
	}
	...
	?>
		<script language="JavaScript">
		alert ('Isian stok buku masih kosong. Silahkan diisi dahulu');
		document.location='isi-buku.php';
		</script>
	<?php
	}
		...
		$pilih="select * from buku where barcode='$barcode'";
		...
		<?php
			...
			$query="insert into buku (Barcode, Nama, Penulis, Jenis, Tahun,Stok) values
