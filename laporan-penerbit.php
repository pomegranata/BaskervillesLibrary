...
$query = "SELECT no, barcode, penerbit, buku, alamat, telepon FROM supplier";
...
?>
		...
		<button onclick="location.href='home.php';" type = "button"> Home </button> <button onclick = "location.href='laporan/penerbit/daftar_penerbit.pdf'" type = "button"> PDF </button>
	</br>
</body>
</html>